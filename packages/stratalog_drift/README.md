...
Statements trace with duration and row/affected counts; transactions and batches included. Failures log at `warning` with the statement attached. `logArgs: false` keeps bound row data out of every sink; long statements are ellipsized.
